appState = {
    user: {
        id: "68e813d9dca8668fc3294b9f",
        email: "ayush@mahasos.com",
        roles: ["user"],
        name: {
            first: "ayush",
        },
    ...
    tenants: [
        {
            ...
            settings: {
                allowSAML: true,
                maxUsers: 100,
                features: ["cloud-connector", "threat-engine", "compliances-engine"],
            },
        ...
        },
        {
            ...
            settings: {
                allowSAML: false,
                maxUsers: 50,
                features: ["cloud-connector", "threat-engine"],
            },
    ...
    notifications: [
        ...
        },
        {
            ...
            message: "New compliances checks are available for GDPR framework",
            category: "system",
            isRead: false,
        ...
        },
        {
            ...
            userId: "2",
            type: "alert",
            title: "compliances Violation Detected",
